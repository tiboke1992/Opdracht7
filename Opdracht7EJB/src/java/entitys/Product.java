...
public class Product implements Serializable {
    ...
    public int getAantalInVooraad() {
        return aantalInVooraad;
    }

    public void setAantalInVooraad(int aantalInVooraad) {
        this.aantalInVooraad = aantalInVooraad;
    }
